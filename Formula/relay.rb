class Relay < Formula
  ...
  desc "Local stdio MCP-backed development memory"
  homepage "https://github.com/LiuShuai26/relay"
  url "https://github.com/LiuShuai26/relay/archive/refs/tags/v0.1.0.tar.gz"
  sha256 "e0e43e36994c8dfa5bbbb81b480b6c1aa193f496acebb57039f315c199ef5d06"
  ...
  test do
    ...
    doctor = shell_output("#{bin}/relay doctor")
    assert_match "relay_home", doctor
    assert_match "index", doctor
  end
end
